...
The [19 September CI run at `2b3d7ae`](https://github.com/builtin-pb/dsh-developer/actions/runs/35415266436) passed all 18 jobs: native development on Windows, macOS and Ubuntu against `latest`, `next` and `alpha`, plus exact audits on DSH 0.1.5-rc.2 and advisory 0.1.6-alpha.2. These checks cover source/archive verification, overlays, HTTP authentication, process cleanup and background-browser suppression. They do not establish rendered Windows browser automation, every architecture or musl. [Verification results](verification.md) distinguish native checks from rendered Web experiments and retain earlier failures. The [v0.1.1 rollout](https://github.com/builtin-pb/dsh-developer/actions/runs/35033208568) and [v0.1.0 release](https://github.com/builtin-pb/dsh-developer/actions/runs/34564186509) remain historical release observations.
