...
export const REVIEWED_HOOK_BRIDGE_LANES = Object.freeze({
  ...
  current: Object.freeze({
    version: '0.1.5-rc.2',
    dsh: Object.freeze({
      manifest: 'sha256:0d9ea2f7a42e7bacf319abd57016e40d0351d07032c7eb709d7c54158300d4cb',
      entry: 'sha256:0ff7f1d72c4e0cbe14001709c81e20a04b70464118a7f78568952988e28f2ac5',
    }),
    bridgeStatus: 'reviewed-partial',
    eventSemantics: Object.freeze({
      sessionStart: 'detached-session-start',
      transcriptPath: 'unavailable',
    }),
    bridges: Object.freeze({
      'codex': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-codex',
        version: '0.1.5-rc.2',
        manifest: 'sha256:4c1d9987eff3e02a1566625d84b788b24ad8ee8f39511d96f112d2b947ec61d0',
        entry: 'sha256:9c2ae8358ae955f0c935d2f38bb9d0b461bfdc7d97cb72fe9fc241839041bd97',
        invariant: null,
      }),
      'claude-code': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-claude-code',
        version: '0.1.5-rc.2',
        manifest: 'sha256:6622f312f82b49cb983b3cf98aba3d2437f95d4747b04f95f2fbaad1f95074ee',
        entry: 'sha256:236633296049129787e3e8de705c5f7bade2fd16a6554ff15ad0e9143cac20a0',
        invariant: null,
      }),
    }),
    protocol: Object.freeze({
      name: PROTOCOL_NAME,
      version: '0.1.5-rc.2',
      manifest: 'sha256:746666b1967e2a36ea7bbab136e034f8757b38c1363dcefd5f636b7b0d243a3a',
      entry: 'sha256:8b03c89ed6529049eb4fb567fff6ad8d593e9405f1cc87487c446d8030be98a3',
      invariant: 'sha256:f70647bd172dd2f0ad04fae6c66c1cb4efa00db34e011cc824a7c6f371bc860c',
    }),
  }),
  alpha: Object.freeze({
    version: '0.1.6-alpha.1',
    dsh: Object.freeze({
      manifest: 'sha256:cdc05ff6850d395e74d76c7e76e64cecd5d5b7f0fb349c54f14680438ba05348',
      entry: 'sha256:cd47a5e19d82b3114c68ace4aeb7f8378e659a248bb7c5cfff25509f14c1c72c',
    }),
    bridgeStatus: 'reviewed-partial',
    eventSemantics: Object.freeze({
      sessionStart: 'awaited-agent-created',
      transcriptPath: 'unavailable',
    }),
    bridges: Object.freeze({
      'codex': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-codex',
        version: '0.1.6-alpha.1',
        manifest: 'sha256:511bf6c3acd6e29c4bef8e374c47ce026615592c3b4e3c28af50030f6db4a0f5',
        entry: 'sha256:6ca2b013b4b7d94935b78ba582d1da85e38c926bdc977afd9000e4322e18f39c',
        invariant: null,
      }),
      'claude-code': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-claude-code',
        version: '0.1.6-alpha.1',
        manifest: 'sha256:ad932aeacca5dc00b79fe9393f651e52834e3c6309f13cbee035b9c690a20f06',
        entry: 'sha256:3d6c04713527a095aacd21449d9c81ff6369093c1c46ca8a3b94c06745fea872',
        invariant: null,
      }),
    }),
    protocol: Object.freeze({
      name: PROTOCOL_NAME,
      version: '0.1.6-alpha.1',
      manifest: 'sha256:2e592c431fe1b6fc418d93ad3f8221f56fb639c5b677eafa9ad2ac174efa4e77',
      entry: 'sha256:8b03c89ed6529049eb4fb567fff6ad8d593e9405f1cc87487c446d8030be98a3',
      invariant: 'sha256:f70647bd172dd2f0ad04fae6c66c1cb4efa00db34e011cc824a7c6f371bc860c',
    }),
  }),
  alpha2: Object.freeze({
    ...
    dsh: Object.freeze({
      manifest: 'sha256:a969831d0bbe6db453932f47defc4ced801cc74361c7540c3c98e5383e5f4d1b',
      entry: 'sha256:69c49c871735dc7ee81ec51f266bbec129f075fd5066e046374f4b13ab02a705',
    }),
    bridgeStatus: 'reviewed-partial',
    eventSemantics: Object.freeze({
      sessionStart: 'awaited-agent-created',
    ...
    bridges: Object.freeze({
      'codex': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-codex',
        version: '0.1.6-alpha.2',
        manifest: 'sha256:29d4fdc879f5dfce5572befd5eb84b9c42ef2f4c3b529c386a2d896c401a270a',
        entry: 'sha256:6ca2b013b4b7d94935b78ba582d1da85e38c926bdc977afd9000e4322e18f39c',
        invariant: null,
      }),
      'claude-code': Object.freeze({
        name: '@deepseek-ai/dsh-hooks-claude-code',
        version: '0.1.6-alpha.2',
        manifest: 'sha256:831d1e6b093a75e02d256dfff747f01395beb49db89b0686676f65d9cca7b3a0',
        entry: 'sha256:3d6c04713527a095aacd21449d9c81ff6369093c1c46ca8a3b94c06745fea872',
        invariant: null,
      }),
    }),
    protocol: Object.freeze({
      name: PROTOCOL_NAME,
      version: '0.1.6-alpha.2',
      manifest: 'sha256:7c04d7240235dee6e38789b769a2b524f1207d2c09f98e1ae54198c02baaa363',
      entry: 'sha256:8b03c89ed6529049eb4fb567fff6ad8d593e9405f1cc87487c446d8030be98a3',
      invariant: 'sha256:f70647bd172dd2f0ad04fae6c66c1cb4efa00db34e011cc824a7c6f371bc860c',
    }),
  }),
...
function sameDirectorySnapshot(left, right) {
  return left.length === right.length && left.every((entry, index) => (
    entry.path === right[index].path && sameDirectoryIdentity(entry, right[index])
  ))
}

async function ordinaryDirectorySnapshot(path, signal, codes) {
  ...
  for (const segment of [null, ...segments]) {
    ...
    const info = await lstat(current, { bigint: true }).catch(() => {
      sourceFailure(codes.unavailable, 'A required static-inspection directory is unavailable.')
    })
    if (info.isSymbolicLink()) {
      sourceFailure(codes.linked, 'A static-inspection directory path traverses a link or junction.')
    }
    if (!info.isDirectory()) {
      sourceFailure(codes.unavailable, 'Every static-inspection directory ancestor must be ordinary.')
    }
...
async function inspectOrdinaryDirectory(path, signal, codes) {
  const before = await ordinaryDirectorySnapshot(path, signal, codes)
  const physical = await realpath(resolve(path)).catch(() => {
    sourceFailure(codes.unavailable, 'A required static-inspection directory cannot be resolved.')
  })
  const after = await ordinaryDirectorySnapshot(path, signal, codes)
  const physicalInfo = await lstat(physical, { bigint: true }).catch(() => {
    sourceFailure(codes.unavailable, 'A required static-inspection directory is unavailable.')
  })
  const physicalIdentity = { dev: String(physicalInfo.dev), ino: String(physicalInfo.ino) }
  if (!physicalInfo.isDirectory()
      || physicalInfo.isSymbolicLink()
      || !sameDirectorySnapshot(before, after)
      || !sameDirectoryIdentity(after.at(-1), physicalIdentity)) {
    sourceFailure(codes.linked, 'A static-inspection directory path changed or resolves through a link or junction.')
  }
  return { physical: resolve(physical), snapshot: after }
}
...
async function authorizeSourcePath(source, sourceRoot, signal) {
  ...
  await inspectOrdinaryDirectory(root, signal, {
    unavailable: 'HOOK_PROJECT_UNAVAILABLE',
    linked: 'HOOK_PROJECT_LINKED',
  })
  return absolute
}

async function readConfigSource(path, sourceRoot, signal) {
  const parentCodes = { unavailable: 'HOOK_SOURCE_UNAVAILABLE', linked: 'HOOK_SOURCE_LINKED' }
  const parentBefore = await ordinaryDirectorySnapshot(dirname(path), signal, parentCodes)
  const lexicalBefore = await lstat(path, { bigint: true }).catch(() => {
  ...
  if (!lexicalBefore.isFile()) {
    sourceFailure('HOOK_SOURCE_UNSAFE', 'Hook configuration must be one ordinary file.')
  }
  ...
  if (!sameDirectoryIdentity(
    { dev: String(lexicalBefore.dev), ino: String(lexicalBefore.ino) },
    { dev: String(physicalInfo.dev), ino: String(physicalInfo.ino) },
  )) {
    sourceFailure('HOOK_SOURCE_LINKED', 'The hook configuration path resolves to a different filesystem object.')
  }
  let projectBefore
  if (sourceRoot !== undefined) {
    projectBefore = await inspectOrdinaryDirectory(sourceRoot, signal, {
      unavailable: 'HOOK_PROJECT_UNAVAILABLE',
      linked: 'HOOK_PROJECT_LINKED',
    })
    if (!inside(projectBefore.physical, physical)) {
      sourceFailure('HOOK_SOURCE_OUTSIDE_PROJECT', 'Native Hook Bridge Doctor accepts only a source inside the current project.')
    }
  }
  ...
  const lexicalAfter = await lstat(path, { bigint: true }).catch(() => undefined)
  const parentAfter = await ordinaryDirectorySnapshot(dirname(path), signal, parentCodes)
  if (!afterPhysical
      || !lexicalAfter
      || !sameStat(lexicalBefore, lexicalAfter)
      || !sameDirectorySnapshot(parentBefore, parentAfter)
      || normalizedPath(afterPhysical) !== normalizedPath(physical)) {
    sourceFailure('HOOK_SOURCE_MUTATED', 'The hook configuration path changed while its snapshot was acquired.')
  }
  if (sourceRoot !== undefined) {
    const projectAfter = await inspectOrdinaryDirectory(sourceRoot, signal, {
      unavailable: 'HOOK_PROJECT_UNAVAILABLE',
      linked: 'HOOK_PROJECT_LINKED',
    })
    if (normalizedPath(projectAfter.physical) !== normalizedPath(projectBefore.physical)
        || !sameDirectorySnapshot(projectAfter.snapshot, projectBefore.snapshot)
        || !inside(projectAfter.physical, afterPhysical)) {
...
async function bridgeInvariant(root, expected, signal) {
  const path = join(root, 'lib', 'invariant.js')
  if (expected !== null) return stableArtifact(path, root, signal)
  // Newer bridges delegate event invariants to the protocol. Null pins absence;
  // it must not silently make an added or unreadable companion acceptable.
  active(signal)
  const present = await lstat(path).catch((error) => {
    if (error?.code === 'ENOENT') return undefined
    sourceFailure('HOOK_BRIDGE_UNREVIEWED', 'The bridge invariant inventory could not be verified.')
  })
  if (present) sourceFailure('HOOK_BRIDGE_UNREVIEWED', 'The reviewed bridge invariant-absence inventory has drifted.')
  return null
}
...
async function inspectLane(dshPath, dialect, signal, dependencies) {
  ...
  const bridgeInvariantSnapshot = await bridgeInvariant(bridge.root, expectedBridge.invariant, signal)
  if (bridgeManifest.name !== expectedBridge.name
      ...
      || artifactMismatch(bridgeInvariantSnapshot?.fingerprint ?? null, expectedBridge.invariant)) {
  ...
  await resealArtifacts([
    ...
    ...(bridgeInvariantSnapshot ? [{ path: bridgeInvariantSnapshot.path, snapshot: bridgeInvariantSnapshot }] : []),
  ...
  if (expectedBridge.invariant === null) await bridgeInvariant(bridge.root, null, signal)
  return {
    id: lane.id,
    dshVersion: lane.version,
    status: lane.bridgeStatus,
    ...(lane.eventSemantics ? { eventSemantics: lane.eventSemantics } : {}),
    dsh: { manifestDigest: manifestSnapshot.fingerprint, entryDigest: entrySnapshot.fingerprint },
    bridge: {
      ...
      invariantDigest: bridgeInvariantSnapshot?.fingerprint ?? null,
    },
    protocol: {
...
function classifyConfig(config, dialect, signal, semantics) {
  const spec = EVENT_SPECS[dialect]
  // Parsing is identical across reviewed lanes. Payload/lifecycle differences
  // also apply to malformed event groups; historical reports stay unchanged.
  const supported = new Map(spec.supported.map((event) => {
    if (!semantics) return [event.name, event]
    const awaitedStart = event.name === 'SessionStart' && semantics.sessionStart === 'awaited-agent-created'
    const limitations = event.limitations.filter((value) => !awaitedStart
      || (value !== 'detached' && value !== 'may-miss-first-request'))
    if (semantics.transcriptPath === 'unavailable') limitations.push('transcript-path-unavailable')
    return [event.name, {
      ...event,
      ...(event.name === 'SessionStart' ? { delivery: semantics.sessionStart } : {}),
      limitations,
    }]
  }))
  ...
  for (let eventIndex = 0; eventIndex < eventKeys.length; eventIndex += 1) {
    ...
    if (!Array.isArray(rawGroups)) {
      issue(issues, 'HOOK_EVENT_GROUPS_INVALID', { eventIndex })
      events.push({ event: name, support: 'mapped-partial', matcherSubject: event.matcherSubject, effects: event.effects, groups: 0, handlers: { runnable: 0, runtimeRunnable: 0, skipped: 0, invalid: 1 }, handlerClasses: [{ classification: 'ignored-malformed', count: 1 }], matcherClasses: [], ...(event.delivery ? { delivery: event.delivery } : {}), limitations: event.limitations })
      totals.invalid += 1
      continue
    }
    if (rawGroups.length > GROUPS_PER_EVENT) sourceFailure('HOOK_GROUP_LIMIT', 'Hook configuration exceeds the bounded groups-per-event limit.')
...
export async function inspectHookBridgeInternal(source, options, dependencies = {}) {
  ...
  try {
    report.config = { status: 'inspected', ...classifyConfig(parsed, options.dialect, options.signal, lane.eventSemantics) }
