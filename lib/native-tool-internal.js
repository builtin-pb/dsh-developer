...
import { formatDelegationSafetyReport } from './delegation-safety.js'
...
export function createNativeToolDefinition(executeOperation) {
  ...
  return {
    ...
    description: 'Inspect DSH, plugin, delegated-agent, and scoped UI-provider evidence without executing arbitrary repository code. Choose capabilities, doctor, preflight, impact, compatibility, delegation, or ui.',
    parameters: {
      type: 'object',
      properties: {
        operation: {
