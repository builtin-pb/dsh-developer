...
export function createNativeToolDefinition(executeOperation) {
  ...
  return {
    ...
    description: 'Inspect DSH and plugin evidence without executing arbitrary repository code. Choose capabilities, doctor, preflight, impact, or compatibility.',
    parameters: {
      type: 'object',
      properties: {
        operation: {
    ...
    async execute(args, exec) {
      ...
      return executeOperation(input, { signal: exec.signal })
    },
  }
}
