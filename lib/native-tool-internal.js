...
export function createNativeToolDefinition(executeOperation) {
  ...
  return {
    ...
    description: 'Inspect DSH, plugin, and scoped UI-provider evidence without executing arbitrary repository code. Choose capabilities, doctor, preflight, impact, compatibility, or ui.',
    parameters: {
      type: 'object',
      properties: {
        operation: {
