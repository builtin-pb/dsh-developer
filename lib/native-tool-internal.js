  ...
  return {
    ...
    parameters: {
      ...
      properties: {
        ...
        source: { type: 'string', description: 'Project, plugin, Creator export, or workspace-confined hook/session file. For knowledge, a workspace DSH checkout or file/package within it; omit for installed packages and use packageName.' },
