  ...
  checks.push(check(
    ...
    injectContract.ok
      ...
      : injectContract.clientPackageInjections.length > 0
        ? 'Host inject contains DSH Client package identifiers; move browser dependencies to package.json dsh.client.inject or remove them from the Host contract.'
        : 'One or more inject assignments are dynamic, outside the supported literal contract, or contain an invalid service name.',
    true,
