...
const LIMITS = Object.freeze({
  ...
  // Native DSH writes each append batch as a frame; one message can fill
  // most of it. Admit records up to the existing decoded-frame capacity.
  frameBytes: 4 * 1024 * 1024, windowBytes: 8 * 1024 * 1024, frames: 4096, lineBytes: 4 * 1024 * 1024,
