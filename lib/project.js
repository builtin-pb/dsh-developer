...
export async function inspectProject(source = '.', options = {}) {
  ...
  if (!selected) return {
    kind: 'dsh-project', ok: true, project: { root: startingDirectory, kind: 'empty' }, tasks: [], instructionFiles,
  ...
  return {
    ...
    upstream, packageManager, tasks, instructionFiles, documentation, notices,
  }
}
